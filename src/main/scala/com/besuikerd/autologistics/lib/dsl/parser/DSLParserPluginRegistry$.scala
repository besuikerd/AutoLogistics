...
trait DSLParserPluginRegistry extends PluggableParsers { this:DSLParser =>
  ...
  private val _binaryOperators:scala.collection.mutable.Map[Int, scala.collection.mutable.Buffer[String]] = scala.collection.mutable.Map()
  ...
  def registerBinaryOperators(precedence:Int, operators:String*):Unit = _binaryOperators.get(precedence) match{
